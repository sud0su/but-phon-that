...
<table class="tg">
    <tr>
        ...
        <th class="colhead" colspan="3" width="70">Korban Berdasakan Status Perkawinan<br></th>
        <th class="colhead" rowspan="2" width="200">Keterangan</th>
    </tr>
    <tr>
        <th class="colhead" >Menikah</th>
        <th class="colhead" >Tidak Menikah</th>
        <th class="colhead" >Sudah Cerai</th>
    </tr>
    <tr>
        <td class="colisi">
            <select>
