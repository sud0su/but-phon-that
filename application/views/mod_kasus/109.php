...
<table class="tg">
    <tr>
        ...
        <th class="colhead" colspan="4" width="70">Pelaku Berdasarkan Status Perkerjaan<br></th>
        <th class="colhead" rowspan="4" width="200">Keterangan</th>
    </tr>
    <tr>
    	<th class="colhead" colspan="2" width="70">Bekerja<br></th>
        <th class="colhead" colspan="2" width="70">Tidak bekerja<br></th>
    </tr>
    <tr>
