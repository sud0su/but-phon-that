...
<table class="tg">
    <tr>
        ...
        <th class="colhead" colspan="8" width="70">PNS Menurut Jabatan Struktural<br></th>
        <th class="colhead" rowspan="3" width="200">Keterangan</th>
    </tr>
    <tr>
        <th class="colhead" colspan="2">Eselon IV</th>
        <th class="colhead" colspan="2">Eselon III</th>
        <th class="colhead" colspan="2">Eselon II</th>
        <th class="colhead" colspan="2">Eselon I</th>
