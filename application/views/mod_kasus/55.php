...
<table class="tg">
    <tr>
        ...
        <th class="colhead" colspan="8" width="70">Jenis Pendidikan Tertinggi Yang di Tamatkan<br></th>
        <th class="colhead" rowspan="3" width="200">Jumlah Penduduk</th>
        <th class="colhead" rowspan="3" width="200">Keterangan</th>
    </tr>
    <tr>
        <th class="colhead" colspan="2">SD</th>
        <th class="colhead" colspan="2">SLTP</th>
        <th class="colhead" colspan="2">SLTA</th>
        <th class="colhead" colspan="2">Lainyan</th>
    </tr>
    <tr>
