...
<table class="tg">
    <tr>
        ...
        <th class="colhead" colspan="4" width="70">Akses Terhadap Informasi dan Teknologi<br></th>
        <th class="colhead" rowspan="2" width="200">Keterangan</th>
    </tr>
    <tr>
        <th class="colhead">Pelanggan Telepon Seluler</th>
        <th class="colhead">Pengguna Personal Komputer</th>
        <th class="colhead">Pengguna Internet</th>
