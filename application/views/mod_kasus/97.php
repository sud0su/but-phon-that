...
<table class="tg">
    <tr>
        ...
        <th class="colhead" colspan="8" width="70">PNS Menurut Pangkat dan Golongan<br></th>
        <th class="colhead" rowspan="3" width="200">Keterangan</th>
    </tr>
    <tr>
        <th class="colhead" colspan="2">Gol. I</th>
        <th class="colhead" colspan="2">Gol. II</th>
        <th class="colhead" colspan="2">Gol. III</th>
        <th class="colhead" colspan="2">Gol. IV</th>
